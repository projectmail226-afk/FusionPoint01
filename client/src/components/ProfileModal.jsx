    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
      <div className='max-w-2xl sm:py-6 mx-auto '>
        <div className='bg-white rounded-lg shadow p-6'>
          ...
          <form className='space-y-4' onSubmit={(e)=>{ e.preventDefault(); toast.promise(handleSaveProfile(e), {loading: 'saving...'})}}>
            {/* Profile Picture */}
            ...
            <div className='flex justify-end space-x-3 pt-6'>
              <button type='button' onClick={() => setShowEdit(false)}className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition cursor-pointer'>Cancel</button>
