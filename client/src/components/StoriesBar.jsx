    ...
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4'>
      ...
      <div className='flex gap-4 pb-5'>
        ...
        <div 
          ...
          className='rounded-lg shadow-sm min-w-[120px] max-w-[120px] max-h-[160px] aspect-[3/4] cursor-pointer border-indigo-300 bg-gradient-to-b from-indigo-50 to-white'
        >
