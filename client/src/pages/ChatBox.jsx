    ...
    <div className="flex flex-col h-screen">
            ...
            .map((m, index) => (
              ...
              >
                <div
                  ...
                  ${m.to_user_id !== user._id ? 'rounded-bl-none' : 'rounded-br-none'}`}
                >
                  {m.message_type === 'image' && (
                    <img src={m.media_url} className="w-full max-w-sm rounded-lg mb-1" alt="" />
                  )}
                  <p>{m.text}</p>
                </div>
              </div>
      ...
      <div className="px-4">
        <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
          ...
          <button
            onClick={sendMessage}
            className="bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 text-white p-2 rounded"
          >
